...
| 2 | 🧮 Kalkulator (3×) | Jun 2026, Apr 2026, Jan 2025 | full-duplex, callback šalje izraz; Jan 2025 je replika Jun 2026 |
| 3 | 💬 Čet (3×) | Jun 2025, Apr 2025, Jun 2023 | duplex, registracija nadimka, slanje po nadimku; prikaz ko/kad/sadržaj |
...
| 5 | 🚗 Registracija vozila (1×) | Sept 2024 | vlasnik + entitet + istorija; broj registracije dodeljuje server |
...
## Mapa porodica (19 rokova = 10 zadataka)
...
| 🧮 Kalkulator (3×) | Jan 2025, Apr 2026, Jun 2026 | sesijsko stanje, duplex callback uz izraz / FaultException varijanta |
| 💬 Čet (3×) | Jun 2023, Apr 2025, Jun 2025 | duplex, rečnik nadimak→callback, usmeravanje poruke primaocu |
| 🔢 Matrice (3×) | Jan 2023, Okt 2 2023, Okt 2025 | server-side stanje (setovana matrica) + zajednička Result struktura |
| 🚗 Registracija vozila (1×) | Sept 2024 | vlasnik + vozilo + istorija registracija, server dodeljuje broj |
...
Napomena: porodice 1–4 pokrivaju 11 od 19 rokova (58%), 1–6 čak 15/19 (~79%), a sa sokovima 18/19 (95%). Ako se nađu stariji tekstovi (G2021 i ranije), mapa se dopunjuje.
